...
DEFINE_THISCALL_WRAPPER(winISteamClient_SteamClient017_GetISteamUnifiedMessages, 16)
winISteamUnifiedMessages * __thiscall winISteamClient_SteamClient017_GetISteamUnifiedMessages(winISteamClient_SteamClient017 *_this, HSteamUser hSteamuser, HSteamPipe hSteamPipe, const char * pchVersion)
{
    TRACE("%p\n", _this);
    return create_win_interface(pchVersion,
        cppISteamClient_SteamClient017_GetISteamUnifiedMessages(_this->linux_side, hSteamuser, hSteamPipe, pchVersion));
}
...
void __asm_dummy_vtables(void) {
    ...
    __ASM_VTABLE(winISteamClient_SteamClient017,
        ...
        VTABLE_ADD_FUNC(winISteamClient_SteamClient017_CreateSteamPipe /* protected: RunFrame */)
        ...
        VTABLE_ADD_FUNC(winISteamClient_SteamClient017_GetISteamUnifiedMessages)
        ...
        VTABLE_ADD_FUNC(winISteamClient_SteamClient017_CreateSteamPipe /* protected: DEPRECATED_Set_SteamAPI_CPostAPIResultInProcess */)
        VTABLE_ADD_FUNC(winISteamClient_SteamClient017_CreateSteamPipe /* protected: DEPRECATED_Remove_SteamAPI_CPostAPIResultInProcess */)
        VTABLE_ADD_FUNC(winISteamClient_SteamClient017_CreateSteamPipe /* protected: Set_SteamAPI_CCheckCallbackRegisteredInProcess */)

...
void __asm_dummy_vtables(void) {
    ...
    __ASM_VTABLE(winISteamUtils_SteamUtils008,
        ...
        VTABLE_ADD_FUNC(winISteamUtils_SteamUtils008_GetSecondsSinceAppActive /* protected: RunFrame */)
...
void __asm_dummy_vtables(void) {
    ...
    __ASM_VTABLE(winISteamUtils_SteamUtils007,
        ...
        VTABLE_ADD_FUNC(winISteamUtils_SteamUtils007_GetSecondsSinceAppActive /* protected: RunFrame */)
